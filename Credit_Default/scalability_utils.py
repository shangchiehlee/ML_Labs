...
Author: Shane Lee
Description: Shared Library. Provides container-aware resource management via Cgroup inspection.
             Implements probabilistic data structures (Bloom Filters) and standardised JSON logging configuration.
"""
