...
Workflow:
    ...
    5. Copies report files to the `outputs/` directory when present.
...
def publish_reports(artifact_path: Path, output_dir: Path) -> None:
    """Copies report files from downloaded outputs into the local output directory.

    Args:
        artifact_path: Source directory of downloaded assets.
        output_dir: Target directory for local report copies.
    """
    ...
    # Search candidate output subpaths
