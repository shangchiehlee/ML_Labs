...
Purpose:
    ...
    processes, minimising the Resident Set Size (RSS). Enforces strict contract
    validation against the output schema and calculates continuous admission
    probabilities.
...
Workflow:
    ...
    4. Workers compute regression predictions.
...
# Shared Worker State
# Global variable for ProcessPoolExecutor to share via COW/mmap
