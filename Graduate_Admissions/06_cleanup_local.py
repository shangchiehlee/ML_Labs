...
Safety Mechanisms:
    *   Uses standard library utilities only to reduce file-locking risk.
    *   Implements permission handling for read-only artefacts during deletion.
...
def remove_readonly(func: Callable, path: str, excinfo: Any) -> None:
    ...
    If a file is Read-Only (common with retrieved artefacts), this forces
